...
./artisan ui -vvv --auth -- [bootstrap, vue, react]
# Scaffold the authentication controllers
./artisan ui:controllers -vvv
# Scaffold basic login and registration views and routes
./artisan ui:auth -vvv --force --views -- [bootstrap, vue, react]
...
```bash
./artisan make:controller -vvv --force --resource -- Admin/UserController
./artisan make:controller -vvv --force --resource -- Admin/PermissionController
./artisan make:controller -vvv --force --resource -- Admin/RoleController

./artisan make:controller -vvv --force --resource --model=App\\Models\\User -- UserController

./artisan make:controller -vvv --force --api -- Api\\AuthController
./artisan make:controller -vvv --force --api -- Api\\JWTAuthController
./artisan make:controller -vvv --force --api -- Api\\UserController
./artisan make:controller -vvv --force --api -- App\\Modules\\Api\\Routes\\Controllers\\RouteController
```
## Create a new middleware class
```bash
./artisan make:middleware -vvv Locale
```
...
./artisan make:model -vvv --force --migration --seed --factory --controller --api -- App\\Models\\Setup
./artisan make:model -vvv --force --migration --seed --factory --controller --api -- App\\Models\\Person
./artisan make:model -vvv --force --migration --seed --factory --controller --api -- App\\Models\\Group
./artisan make:model -vvv --force --migration --seed --factory --controller --api -- App\\Models\\Role
./artisan make:model -vvv --force --migration --seed --factory --controller --api -- App\\Models\\Permission
./artisan make:model -vvv --force --migration --seed --factory --controller --api -- App\\Models\\Organization
```
## api generate
## composer require rodrixcornell/apigenerate
```bash

docker exec -it --user ${UID}:${GID} php-cli bash -c './artisan generate:api -vvv --con=mysql'

./artisan generate:api -vvv --con=mysql
./artisan generate:api -vvv --relation=true --table=users
./artisan generate:api -vvv --relation=true --table=organizations
./artisan generate:api -vvv --relation=true --table=failed_jobs
./artisan generate:api -vvv --relation=true --table=users --module=Api
./artisan generate:api -vvv --relation=true --table=users --route=my-users-route
./artisan generate:api -vvv --relation=true --table=users --route=my-users-route --module=Api
./artisan generate:api -vvv --relation=true --table=groups --route=groups
./artisan generate:api -vvv --relation=true --table=groupuser --route=groupuser
```
